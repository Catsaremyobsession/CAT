-- troll/init.lua
-- Handles: folder setup, image & sound download, overlay + rickify parts

--// Folder Setup
if not isfolder("troll") then makefolder("troll") end
if not isfolder("troll/imgs") then makefolder("troll/imgs") end
if not isfolder("troll/sounds") then makefolder("troll/sounds") end
...
downloadIfMissing("troll/imgs/rick.png", "https://raw.githubusercontent.com/Catsaremyobsession/CAT/main/imgs/rick.png")
downloadIfMissing("troll/imgs/rick2.png", "https://raw.githubusercontent.com/Catsaremyobsession/CAT/main/imgs/rick2.png")
downloadIfMissing("troll/sounds/troll.mp3", "https://raw.githubusercontent.com/Catsaremyobsession/CAT/main/sounds/troll.mp3")
...
do
    ...
    img.Image = getcustomasset("troll/imgs/rick.png")
    img.ZIndex = 10
    img.Parent = sg
...
local rickTexturePath = getcustomasset("troll/imgs/rick2.png")
